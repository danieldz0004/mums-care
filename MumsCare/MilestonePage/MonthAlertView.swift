...
class MonthAlertView: UIView {
    ...
    lazy var backImageView:UIImageView = {
        ...
        backImageView.frame = CGRect(x: (UIScreen.main.bounds.size.width - 350) * 0.5, y: 200, width: 350, height: 250)
        //        backImageView.image = UIImage.init(named: "BGWonLose")
        return backImageView
    }()
    lazy var enterBtn:UIButton = {
        var enterBtn = UIButton(type: .custom)
        enterBtn.frame = CGRect(x: (UIScreen.main.bounds.size.width - 350) * 0.5 + 120, y: 469, width: 32.5, height: 32.5)
    ...
    lazy var cancleBtn:UIButton = {
        ...
        cancleBtn.frame = CGRect(x: (UIScreen.main.bounds.size.width - 350) * 0.5 + 180.0, y: 465.0, width: 40, height: 40)
